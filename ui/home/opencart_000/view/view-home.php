...
<div id="slider">
    <div class="slider-text">
        <h1 class="slider-text-heading"><?php echo web_name(); ?></h1>
        ...
        <div id="content" class="col-sm-12">
            ...
            <div class="col-sm-12">
                ...
                <div class="introduce">
                    ...
                    <div class="row col introduce__container">
                        <div class="col-6 col-sm-12 introduce__content">
                            <div class="introduce__content-wrap">
                                <div class="introduce__content-text">
                                    <span><span class="introduce-text-header"><?php echo web_name(); ?></span> được xây dựng dựa trên tiêu chí là cổng thông tin khổng lồ và hoàn toàn miễn phí về các vấn đề xung quanh động vật , đặc biệt là thú cưng, cụ thể như các bệnh về chó mèo, các thực phẩm dinh dưỡng dành cho thú cưng, cách chăm sóc và điều trị bệnh cho chó mèo...</span>
                                </div>
                                <div class="introduce__content-text">
                                    <span>Tất cả những thông tin tại <span class="introduce-text-header"><?php echo web_name(); ?></span> được sưu tầm và tham khảo từ nhiều nguồn khác nhau có chọn lọc, bên cạnh đó còn là trải nghiệm thực tế của chúng tôi trong quá trình nuôi thú cưng để đem đến cho độc giả những thông tin chính xác và hữu ích nhất.</span>
                                </div>
                            </div>
                        </div>
            ...
            <h1 class="brand">Danh Mục Nổi Bật</h1>
    ...
    <div class="container">
        <div class="col-sm-12">
            <div class="commit__heading">
                ...
                <div class="commit-text"><?php echo web_name(); ?> được định hình là trang web về động vật, thú cưng hàng đầu. Chúng tôi cam kết tất cả nội dung cung cấp trên trang đều được trích dịch từ các nguồn web nước ngoài rõ ràng, có ý kiến và trích dẫn thú y. Từ đó mang lại những trải nghiệm tối nhất cho người xem.</div>
            </div>
            ...
            <div class="row commit__content">
                <div class="col-md-4 col-sm-12 commit__content-wrap">  
                    ...
                    <div class="commit__content-text">Nội dung chất lượng, chính xác, có nguồn uy tín, có thú y xem xét.</div>
                </div>
                <div class="col-md-4 col-sm-12 commit__content-wrap">
                    <div class="commit__content-icon">
                    ...
                    <div class="commit__content-text">Thú cưng chất lượng, dễ thương, được kiểm định chuẩn xác theo tiêu chuẩn.</div>
                </div>
                <div class="col-md-4 col-sm-12 commit__content-wrap">
                    <div class="commit__content-icon">
                    ...
                    <div class="commit__content-text">Hỗ trợ hết mình, hướng dẫn những nguồn khám bệnh thú cưng uy tín, chất lượng.</div>
                </div>
            </div>
        </div>
    </div>
...
<div class="friends">
    <div class="container">
        <div class="col friends__heading">
            ...
            <div class="friends__heading-text"><?php echo web_name(); ?> cung cấp những bài viết thông tin chủ yếu cho 4 loại thú cưng rất thường gặp và là những người bạn thân thiết dễ dàng bắt gặp tại mỗi gia đình người Việt chúng ta. Đó là: Chó, Mèo, Chim và Hamster.</div>
            <div class="friends__heading-text">Ngoài ra chúng tôi vẫn có 1 số bài viết về những loại động vật khác nhưng sẽ ít hơn.</div>
        </div>

        <div class="row col friends__wrap">
    ...
    <div class="new__posts-heading">
        <div class="container">
            <div class="col new__posts-heading-wrap">
                ...
                <div class="new__posts-header-text">Dưới đây là những thú cưng mới mới nhất tại <?php echo web_name(); ?>:</div>
            </div>
        </div>
    </div>
</div>
...
<div class="container">
    <div class="row">
        ...
        <div style="height: 400px;position: relative; background-color: rgb(229, 227, 223); overflow: hidden;" id="google-map" class="col-sm-12">
