...
<HEAD>
    ...
    <link href="/ui/src/js/jquery/plugins/owl-carousel/owl.carousel.css" rel="stylesheet" type="text/css"
        media="screen">
                    ...
                    <LI class="dropdown">
                        ...
                        <?php } else { ?>
                            <A title="My Account" class="dropdown-toggle" href="/account.php" data-toggle="dropdown"><I
                                    class="fa fa-user"></I> <SPAN class="hidden-xs hidden-sm hidden-md">Tài Khoản</SPAN>
        ...
        <DIV class="container">
            <DIV class="row">
                <DIV class="col-sm-4">
                    <DIV id="logo">
                        <A href="/">
                            <IMG height="64" width="64" title="<?php echo web_name(); ?>" class="img-responsive"
                                alt="<?php echo web_name(); ?>" src="<?php echo web_logo_url(); ?>">
                        </A>
                    </DIV>
                </DIV>
                <DIV class="col-sm-5">
                    <DIV class="input-group" id="search">
                        <INPUT name="search-post" class="form-control input-lg" type="text"
                            placeholder="Tìm bài viết..." value="">
