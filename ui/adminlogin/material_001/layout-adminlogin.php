  ...
  <h2>Admin Login</h2>
    <form action="/admin-login.php" method="POST" class="form login">
      ...
      <div class="form__field">
        ...
        <input value="<?php echo $_SESSION['FAILED_USERNAME']; ?>" onkeydown="enterToSubmit();" autocomplete="username" id="login__username" type="text" name="username" class="form__input" placeholder="Username" required>
      </div>
      ...
      <div class="form__field">
        ...
        <input value="<?php echo $_SESSION['FAILED_PASSWORD']; ?>" id="login__password" type="password" name="password" class="form__input" placeholder="Password" required>
      </div>
      ...
      <a class="btn-submit" href="#" onclick="submitFormLogin();">Sign In</a>
      <div class="form__field">
      </div>
